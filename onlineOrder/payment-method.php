...
if (strlen($_SESSION['login']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        ...
        while ($row = mysqli_fetch_array($sql)) {
            ...
            $mail->SMTPAuth = true;
            $mail->Username = "1art10090@gmail.com";
            $mail->Password = "rahulgoyal";
            $mail->SMTPSecure = "tls";
            $mail->Port = 587;

            $mail->From = "1art10090@gmail.com";
            $mail->FromName = "iEat Pizza";
            ...
            $mail->Body = "<B>Thank you for placing an Order. Your order will be delivered shortly. </B>";
